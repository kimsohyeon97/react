    ...
    <div className="RouteDataComponent">
      ...
      <form>
        ...
        <input
          type="button"
          value="쿼리 스트링 전송"
          onChange={button1Handler}
        />
        <br />
        <input
          type="button"
          value="주소 파라미터 전송"
          onChange={button2Handler}
        />
        <br />
        <input type="button" value="state 전송" onChange={button3Handler} />
        <br />
      </form>

      <Routes>
        <Route path='/result1' element={<Result1Component />}></Route>
        <Route path='/result2/:name/:email/:age' element={<Result2Component />}></Route>
